  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Heritage textile showroom in Gadhinglaj since 1965. Sarees, bridal lehengas, sherwanis, Lagna Basta sets and Bombay Kids collections.",
      },
      { name: "author", content: "Bombay Cloth Center" },
